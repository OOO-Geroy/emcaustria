...
if ( ! function_exists( 'generate_scripts' ) ) {
	...
	function generate_scripts() {
		...
		wp_enqueue_style( 'slider-cst',  $dir_uri . "/css/slider.css", array( 'generate-style' ), '2.3.22', 'all' );
		...
		if ( is_active_sidebar( 'header' ) ) {
			wp_enqueue_style( 'header-label-css', get_template_directory_uri() . '/css/widgets/header-label.css', array(), GENERATE_VERSION, 'all' );
		}
